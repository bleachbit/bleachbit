...
class UpdateTestCase(common.BleachbitTestCase):
    ...
    def test_UpdateCheck_fake(self):
        ...
        update_tests = [
            (f'<updates><stable ver="0.8.4">http://084</stable><beta ver="0.8.5beta">http://085beta</beta>{wa}</updates>',
             (('0.8.4', 'http://084'), ('0.8.5beta', 'http://085beta'))),
            (f'<updates><stable ver="0.8.4">http://084</stable>{wa}</updates>',
             (('0.8.4', 'http://084'), )),
            (f'<updates><beta ver="0.8.5beta">http://085beta</beta>{wa}</updates>',
