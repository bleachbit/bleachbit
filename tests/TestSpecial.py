...
class SpecialTestCase(common.BleachbitTestCase, SpecialAssertions):
    ...
    def test_delete_mozilla_no_historyvisits(self):
        """Test for delete_mozilla_url_history without moz_historyvisits table

        See https://github.com/bleachbit/bleachbit/issues/1928
        """
        sql_no_historyvisits = firefox78_places_sql + ";\ndrop table moz_historyvisits;"
        self.sqlite_clean_helper(
            sql_no_historyvisits, None, Special.delete_mozilla_url_history)
