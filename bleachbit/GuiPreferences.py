...
from bleachbit.Common import _, _p, online_update_notification_enabled
...
class PreferencesDialog:
    ...
    def __general_page(self):
        ...
        cb_shred = Gtk.CheckButton.new_with_label(label=_("Overwrite contents of files to prevent recovery"))
