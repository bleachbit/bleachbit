...
"C:\Program Files (x86)\NSIS\makensis.exe" /V3 /DVERSION=2.3.0.1080 /Dpackhdr /DCompressor bleachbit.nsi
"C:\Program Files (x86)\NSIS\makensis.exe" /V3 /DVERSION=2.3.0.1080 /DNoTranslations /Dpackhdr /DCompressor bleachbit.nsi
"C:\Program Files (x86)\NSIS\makensis.exe" /V3 /DVERSION=2.3.0.1080 /DBetaTester /DPathToCleanerML=".." /Dpackhdr /DCompressor bleachbit.nsi
