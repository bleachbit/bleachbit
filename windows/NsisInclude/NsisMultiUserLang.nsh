...
!ifdef LANG_ESTONIAN
	...
	LangString MULTIPRINT1 ${LANG_ESTONIAN} "The next step is building the font cache, during which a black console window may appear."
	LangString MULTIPRINT2 ${LANG_ESTONIAN} "It usually finishes in one minute, but sometimes it takes up to ten minutes."
	...
	LangString MULTIUSER_INSTALLED_CURRENT_USER ${LANG_ESTONIAN} "Version {VERSION} is installed for the current user in $\"{FOLDER}$\"."
	LangString MULTIUSER_INSTALL_HEADER ${LANG_ESTONIAN} "Select whether to install $(^NameDA) for all users or for the current user."
	...
	LangString MULTIUSER_NEW_INSTALLATION_CURRENT_USER ${LANG_ESTONIAN} "Fresh installation for the current user."
	...
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_CURRENT_USER ${LANG_ESTONIAN} "Uninstall version {OLD_VERSION} and install version {VERSION} for the current user."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_ALL_USERS ${LANG_ESTONIAN} "Reinstall version {VERSION} for all users."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_CURRENT_USER ${LANG_ESTONIAN} "Reinstall version {VERSION} for the current user."
	LangString MULTIUSER_RUN_AS_ADMIN ${LANG_ESTONIAN} "You need to run this program as an administrator."
	LangString MULTIUSER_UNINSTALL_HEADER ${LANG_ESTONIAN} "$(^NameDA) is installed both for all users and for the current user.$\r$\nSelect which installation to remove."
	...
	LangString SECTION_QUICK_LAUNCH_DESCRIPTION ${LANG_ESTONIAN} "Lisa link töölauale."
	LangString SECTION_QUICK_LAUNCH_NAME ${LANG_ESTONIAN} "Quick Launch"
	LangString SECTION_SHORTCUTS_DESCRIPTION ${LANG_ESTONIAN} "Lisa link töölauale."
	LangString SECTION_SHORTCUTS_NAME ${LANG_ESTONIAN} "Kiirklahvid"
	LangString SECTION_START_MENU_DESCRIPTION ${LANG_ESTONIAN} "Lisa otsetee Start-menüüsse."
	LangString SECTION_START_MENU_NAME ${LANG_ESTONIAN} "Start menu"
	LangString SECTION_TRANSLATIONS_DESCRIPTION ${LANG_ESTONIAN} "Install language files to use ${prodname} in your preferred local language."
...
!ifdef LANG_INDONESIAN
	...
	LangString MULTIPRINT1 ${LANG_INDONESIAN} "Langkah berikutnya adalah membangun cache font, selama proses ini Anda mungkin melihat jendela hitam."
	LangString MULTIPRINT2 ${LANG_INDONESIAN} "Biasanya selesai dalam satu menit, tetapi terkadang memerlukan waktu sepuluh menit."
	...
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_CURRENT_USER ${LANG_INDONESIAN} "Hapus instalasi versi {OLD_VERSION} dan instal versi {VERSION} untuk pengguna saat ini."
	...
	LangString SECTION_CORE_DESCRIPTION ${LANG_INDONESIAN} "Ini adalah file dasar yang diperlukan agar ${prodname} berfungsi (wajib)."
	...
	LangString SECTION_QUICK_LAUNCH_DESCRIPTION ${LANG_INDONESIAN} "Buat pintasan di Quick Launch."
	LangString SECTION_QUICK_LAUNCH_NAME ${LANG_INDONESIAN} "Quick Launch"
	LangString SECTION_SHORTCUTS_DESCRIPTION ${LANG_INDONESIAN} "Buat pintasan ke ${prodname} di -"
	...
	LangString SECTION_TRANSLATIONS_DESCRIPTION ${LANG_INDONESIAN} "Install language files to use ${prodname} in your preferred local language."
	LangString SECTION_TRANSLATIONS_NAME ${LANG_INDONESIAN} "Terjemahan"
	LangString SECTION_UNINSTALL_DESCRIPTION ${LANG_INDONESIAN} "Tambahkan program penghapus instalasi."
