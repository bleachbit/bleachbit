...
!ifdef LANG_ENGLISH
	...
	LangString NAME_SECTION_CORE ${LANG_ENGLISH} "Core (Required)"
	LangString NAME_SECTION_SHORTCUTS ${LANG_ENGLISH} "Shortcuts"
	LangString NAME_SECTION_START_MENU ${LANG_ENGLISH} "Start menu"
	LangString NAME_SECTION_DESKTOP ${LANG_ENGLISH} "Dsktop"
	LangString NAME_SECTION_QUICK_LAUNCH ${LANG_ENGLISH} "Quick launch"
	LangString NAME_SECTION_TRANSLATIONS ${LANG_ENGLISH} "Translations"
	LangString NAME_SECTION_INTEGRATE_SHRED ${LANG_ENGLISH} "Integrate Shred"
	LangString NAME_SECTION_UNINSTALL ${LANG_ENGLISH} "Uninstall"
	LangString LONG_DESC_SECTION_CORE ${LANG_ENGLISH} "The main file of the program."
	LangString LONG_DESC_SECTION_SHORTCUTS ${LANG_ENGLISH} "Creation of shortucts."
	LangString LONG_DESC_SECTION_START_MENU ${LANG_ENGLISH} "Creation of shortcut in Start menu."
	LangString LONG_DESC_SECTION_DESKTOP ${LANG_ENGLISH} "Creation of shortcut on desktop."
	LangString LONG_DESC_SECTION_QUICK_LAUNCH ${LANG_ENGLISH} "Creation of shortcut on Quick Launch."
	LangString LONG_DESC_SECTION_TRANSLATION ${LANG_ENGLISH} "Install language files."
	LangString LONG_DESC_SECTION_SHRED ${LANG_ENGLISH} "Install integrate shredder."
	LangString LONG_DESC_SECTION_UNINSTALL ${LANG_ENGLISH} "Uninstall program."
...
!ifdef LANG_ITALIAN
	...
	; text string for installer section
	LangString NAME_SECTION_CORE ${LANG_ITALIAN} "Programma (richiesto)"
	LangString NAME_SECTION_SHORTCUTS ${LANG_ITALIAN} "Collegamenti"
	LangString NAME_SECTION_START_MENU ${LANG_ITALIAN} "Menu Start"
	LangString NAME_SECTION_DESKTOP ${LANG_ITALIAN} "Dsktop"
	LangString NAME_SECTION_QUICK_LAUNCH ${LANG_ITALIAN} "Avvio rapido"
	LangString NAME_SECTION_TRANSLATIONS ${LANG_ITALIAN} "File lingua interfaccia"
	LangString NAME_SECTION_INTEGRATE_SHRED ${LANG_ITALIAN} "Modulo sovrascrittura"
	LangString NAME_SECTION_UNINSTALL ${LANG_ITALIAN} "Modulo disinstallazione"
	...
	LangString LONG_DESC_SECTION_CORE ${LANG_ITALIAN} "File principali del programma."
	LangString LONG_DESC_SECTION_SHORTCUTS ${LANG_ITALIAN} "Crea collegamenti."
	LangString LONG_DESC_SECTION_START_MENU ${LANG_ITALIAN} "Crea un collegamento nel menu Start."
	LangString LONG_DESC_SECTION_DESKTOP ${LANG_ITALIAN} "Crea un collegamento sul desktop."
	LangString LONG_DESC_SECTION_QUICK_LAUNCH ${LANG_ITALIAN} "Crea un collegamento in Avvio rapido."
	LangString LONG_DESC_SECTION_TRANSLATION ${LANG_ITALIAN} "Installa i file lingua interfaccia."
	LangString LONG_DESC_SECTION_SHRED ${LANG_ITALIAN} "Installa il modulo sovrascrittura file integrato."
	LangString LONG_DESC_SECTION_UNINSTALL ${LANG_ITALIAN} "Include il programma per la disinstallazione."
