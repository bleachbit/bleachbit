...
!ifdef LANG_ITALIAN
	...
	LangString MULTIUSER_INSTALLED_ALL_USERS ${LANG_ITALIAN} "La versione {VERSION} è stata installata per tutti gli utenti in $\"{FOLDER}$\"."
	...
	LangString MULTIUSER_PAGE_TITLE ${LANG_ITALIAN} "Scegli una cartella"
	...
	LangString SECTION_CORE_DESCRIPTION ${LANG_ITALIAN} "This are the basic files needed for ${prodname} to function (required)."
	LangString SECTION_CORE_NAME ${LANG_ITALIAN} "Scegli i file da eliminare con sovrascrittura"
	LangString SECTION_DESKTOP_DESCRIPTION ${LANG_ITALIAN} "Create the shortcut on desktop."
	LangString SECTION_DESKTOP_NAME ${LANG_ITALIAN} "Widget desktop"
	LangString SECTION_INTEGRATE_SHRED_DESCRIPTION ${LANG_ITALIAN} "Add an option to delete files from the file context menu in Windows explorer."
	LangString SECTION_INTEGRATE_SHRED_NAME ${LANG_ITALIAN} "Integrate Shred"
	LangString SECTION_QUICK_LAUNCH_DESCRIPTION ${LANG_ITALIAN} "Create the shortcut on Quick Launch."
	LangString SECTION_QUICK_LAUNCH_NAME ${LANG_ITALIAN} "Quick launch"
	LangString SECTION_SHORTCUTS_DESCRIPTION ${LANG_ITALIAN} "Create shortcuts to ${prodname} on -"
	LangString SECTION_SHORTCUTS_NAME ${LANG_ITALIAN} "Shortcuts"
	LangString SECTION_START_MENU_DESCRIPTION ${LANG_ITALIAN} "Create the shortcut in Start menu."
	LangString SECTION_START_MENU_NAME ${LANG_ITALIAN} "Start menu"
	LangString SECTION_TRANSLATIONS_DESCRIPTION ${LANG_ITALIAN} "Use ${prodname} in your preferred local system language, install the needed language files."
	LangString SECTION_TRANSLATIONS_NAME ${LANG_ITALIAN} "Localizzazioni"
	LangString SECTION_UNINSTALL_DESCRIPTION ${LANG_ITALIAN} "Add uninstall program."
	LangString SECTION_UNINSTALL_NAME ${LANG_ITALIAN} "Aggiorna i disinstallatori"
	LangString SHORTCUT_DEBUGGING_TERMINAL ${LANG_ITALIAN} "${prodname} Debugging Terminal"
	LangString SHORTCUT_NO_UAC ${LANG_ITALIAN} "${prodname} No UAC."
	LangString SHRED_SHELL_MENU ${LANG_ITALIAN} "Shred with ${prodname}"
...
!ifdef LANG_RUSSIAN
	...
	LangString MULTIUSER_ADMIN_UNINSTALL_CREDENTIALS_REQUIRED ${LANG_RUSSIAN} "Привелегии администратора необходимы для очистки Обновлений Windows"
	...
	LangString SECTION_TRANSLATIONS_NAME ${LANG_RUSSIAN} "Локализации"
