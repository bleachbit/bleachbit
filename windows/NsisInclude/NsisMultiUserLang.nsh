...
!ifdef LANG_ITALIAN
	LangString ALREADY_INSTALLED ${LANG_ITALIAN} "${prodname} is already installed.$\r$\nClick 'OK' to uninstall the old version before upgrading, or click 'Cancel' to abort the upgrade."
	LangString BLEACHBIT_MUI_FINISHPAGE_LINK ${LANG_ITALIAN} "Visit the ${prodname} web site"
	LangString INSTALLER_CAPTION ${LANG_ITALIAN} "${prodname} ${VERSION} Setup"
	LangString MULTIPRINT1 ${LANG_ITALIAN} "The next step is building font cache, during which you may see a black window."
	LangString MULTIPRINT2 ${LANG_ITALIAN} "It usually finishes in one minute, but sometimes it takes ten minutes."
