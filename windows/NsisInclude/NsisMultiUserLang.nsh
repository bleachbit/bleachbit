...
!ifdef LANG_GREEK
	...
	LangString MULTIUSER_ADMIN_UNINSTALL_CREDENTIALS_REQUIRED ${LANG_GREEK} "Απαιτούνται δικαιώματα διαχειριστή για τον καθαρισμό των ενημερώσεων των Windows"
...
!ifdef LANG_HEBREW
	...
	LangString SECTION_CORE_NAME ${LANG_HEBREW} "בחרו קבצים להשמדה"
	LangString SECTION_DESKTOP_DESCRIPTION ${LANG_HEBREW} "Create the shortcut on desktop."
	LangString SECTION_DESKTOP_NAME ${LANG_HEBREW} "וידג׳טים לסביבת שולחן העבודה"
...
!ifdef LANG_SIMPCHINESE
	...
	LangString MULTIUSER_ADMIN_UNINSTALL_CREDENTIALS_REQUIRED ${LANG_SIMPCHINESE} "清除 Windows Update 文件需要管理员权限"
	...
	LangString MULTIUSER_PAGE_TITLE ${LANG_SIMPCHINESE} "选择一个文件夹"
	...
	LangString SECTION_CORE_NAME ${LANG_SIMPCHINESE} "选择要粉碎的文件"
	LangString SECTION_DESKTOP_DESCRIPTION ${LANG_SIMPCHINESE} "Create the shortcut on desktop."
	LangString SECTION_DESKTOP_NAME ${LANG_SIMPCHINESE} "桌面小部件"
	...
	LangString SECTION_TRANSLATIONS_NAME ${LANG_SIMPCHINESE} "本地化文件"
	LangString SECTION_UNINSTALL_DESCRIPTION ${LANG_SIMPCHINESE} "Add uninstall program."
	LangString SECTION_UNINSTALL_NAME ${LANG_SIMPCHINESE} "更新的卸载工具"
