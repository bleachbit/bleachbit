...
!ifdef LANG_FRENCH
	...
	LangString MULTIPRINT1 ${LANG_FRENCH} "The next step is building the font cache, during which a black console window may appear."
	LangString MULTIPRINT2 ${LANG_FRENCH} "It usually finishes in one minute, but sometimes it takes up to ten minutes."
	...
	LangString MULTIUSER_INSTALLED_CURRENT_USER ${LANG_FRENCH} "Version {VERSION} is installed for the current user in $\"{FOLDER}$\"."
	LangString MULTIUSER_INSTALL_HEADER ${LANG_FRENCH} "Select whether to install $(^NameDA) for all users or for the current user."
	...
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_CURRENT_USER ${LANG_FRENCH} "Uninstall version {OLD_VERSION} and install version {VERSION} for the current user."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_ALL_USERS ${LANG_FRENCH} "Reinstall version {VERSION} for all users."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_CURRENT_USER ${LANG_FRENCH} "Reinstall version {VERSION} for the current user."
	LangString MULTIUSER_RUN_AS_ADMIN ${LANG_FRENCH} "You need to run this program as an administrator."
	LangString MULTIUSER_UNINSTALL_HEADER ${LANG_FRENCH} "$(^NameDA) is installed both for all users and for the current user.$\r$\nSelect which installation to remove."
	LangString MULTIUSER_UNINSTALL_PAGE_SUBTITLE ${LANG_FRENCH} "Choose for which users to remove $(^NameDA)."
	LangString SECTION_CORE_DESCRIPTION ${LANG_FRENCH} "These are the basic files needed for ${prodname} to function (required)."
	...
	LangString SECTION_QUICK_LAUNCH_DESCRIPTION ${LANG_FRENCH} "Create a shortcut on the Quick Launch bar."
	...
	LangString SECTION_START_MENU_DESCRIPTION ${LANG_FRENCH} "Create a shortcut in the Start menu."
	LangString SECTION_START_MENU_NAME ${LANG_FRENCH} "Start menu"
	LangString SECTION_TRANSLATIONS_DESCRIPTION ${LANG_FRENCH} "Install language files to use ${prodname} in your preferred local language."
...
!ifdef LANG_HUNGARIAN
	...
	LangString SECTION_TRANSLATIONS_DESCRIPTION ${LANG_HUNGARIAN} "Install language files to use ${prodname} in your preferred local language."
...
!ifdef LANG_SWEDISH
	...
	LangString MULTIPRINT1 ${LANG_SWEDISH} "The next step is building the font cache, during which a black console window may appear."
	LangString MULTIPRINT2 ${LANG_SWEDISH} "It usually finishes in one minute, but sometimes it takes up to ten minutes."
	...
	LangString MULTIUSER_INSTALLED_CURRENT_USER ${LANG_SWEDISH} "Version {VERSION} is installed for the current user in $\"{FOLDER}$\"."
	LangString MULTIUSER_INSTALL_HEADER ${LANG_SWEDISH} "Select whether to install $(^NameDA) for all users or for the current user."
	...
	LangString MULTIUSER_NEW_INSTALLATION_CURRENT_USER ${LANG_SWEDISH} "Fresh installation for the current user."
	...
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_CURRENT_USER ${LANG_SWEDISH} "Uninstall version {OLD_VERSION} and install version {VERSION} for the current user."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_ALL_USERS ${LANG_SWEDISH} "Reinstall version {VERSION} for all users."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_CURRENT_USER ${LANG_SWEDISH} "Reinstall version {VERSION} for the current user."
	LangString MULTIUSER_RUN_AS_ADMIN ${LANG_SWEDISH} "You need to run this program as an administrator."
	LangString MULTIUSER_UNINSTALL_HEADER ${LANG_SWEDISH} "$(^NameDA) is installed both for all users and for the current user.$\r$\nSelect which installation to remove."
	LangString MULTIUSER_UNINSTALL_PAGE_SUBTITLE ${LANG_SWEDISH} "Choose for which users to remove $(^NameDA)."
	LangString SECTION_CORE_DESCRIPTION ${LANG_SWEDISH} "These are the basic files needed for ${prodname} to function (required)."
	LangString SECTION_CORE_NAME ${LANG_SWEDISH} "Välj filer att förstöra"
	LangString SECTION_DESKTOP_DESCRIPTION ${LANG_SWEDISH} "Gränssnittskomponenter för skrivbordet"
	...
	LangString SECTION_QUICK_LAUNCH_DESCRIPTION ${LANG_SWEDISH} "Create a shortcut on the Quick Launch bar."
	...
	LangString SECTION_START_MENU_DESCRIPTION ${LANG_SWEDISH} "Create a shortcut in the Start menu."
	LangString SECTION_START_MENU_NAME ${LANG_SWEDISH} "Start menu"
	LangString SECTION_TRANSLATIONS_DESCRIPTION ${LANG_SWEDISH} "Install language files to use ${prodname} in your preferred local language."
