...
!ifdef LANG_ENGLISH
	...
	LangString SECTION_CORE_DESCRIPTION ${LANG_ENGLISH} "Install the main file of the program (required)."
	LangString SECTION_SHORTCUTS_NAME ${LANG_ENGLISH} "Shortcuts"
	LangString SECTION_SHORTCUTS_DESCRIPTION ${LANG_ENGLISH} "Set the options to create shortcuts."
	LangString SECTION_START_MENU_NAME ${LANG_ENGLISH} "Start menu"
	LangString SECTION_START_MENU_DESCRIPTION ${LANG_ENGLISH} "Create the shortcuts in Start menu."
	...
	LangString SECTION_TRANSLATIONS_DESCRIPTION ${LANG_ENGLISH} "Install all translation files."
...
!ifdef LANG_ITALIAN
	...
	LangString MULTIUSER_ADMIN_CREDENTIALS_REQUIRED ${LANG_ITALIAN} "Richieste credenziali di amministratore."
	LangString MULTIUSER_ADMIN_UNINSTALL_CREDENTIALS_REQUIRED ${LANG_ITALIAN} "Per la disinstallazione sono richieste le credenziali di amministratore."
	; error messages - not so important
	...
	LangString SECTION_CORE_DESCRIPTION ${LANG_ITALIAN} "File del programma principale (richiesti)."
	...
	LangString SECTION_TRANSLATIONS_DESCRIPTION ${LANG_ITALIAN} "Installa i file traduzione interfaccia."
