...
!ifdef LANG_HEBREW
	...
	LangString MULTIUSER_ADMIN_UNINSTALL_CREDENTIALS_REQUIRED ${LANG_HEBREW} "נדרשות הרשאות ניהול להסרה."
	...
	LangString SECTION_QUICK_LAUNCH_DESCRIPTION ${LANG_HEBREW} "יצירת קיצור הדרך בשיגור המהיר."
	LangString SECTION_QUICK_LAUNCH_NAME ${LANG_HEBREW} "שיגור מהיר"
	LangString SECTION_SHORTCUTS_DESCRIPTION ${LANG_HEBREW} "יצירת קיצורי דרך ל־${prodname} תחת -"
	LangString SECTION_SHORTCUTS_NAME ${LANG_HEBREW} "קיצורי דרך"
	LangString SECTION_START_MENU_DESCRIPTION ${LANG_HEBREW} "יצירת קיצור הדרך בתפריט ההתחלה."
	LangString SECTION_START_MENU_NAME ${LANG_HEBREW} "תפריט התחלה"
	LangString SECTION_TRANSLATIONS_DESCRIPTION ${LANG_HEBREW} "Install language files to use ${prodname} in your preferred local language."
	...
	LangString SHORTCUT_NO_UAC ${LANG_HEBREW} "${prodname} אין UAC."
...
!ifdef LANG_PORTUGUESEBR
	...
	LangString MULTIPRINT1 ${LANG_PORTUGUESEBR} "The next step is building the font cache, during which a black console window may appear."
	LangString MULTIPRINT2 ${LANG_PORTUGUESEBR} "It usually finishes in one minute, but sometimes it takes up to ten minutes."
	...
	LangString MULTIUSER_INSTALLED_CURRENT_USER ${LANG_PORTUGUESEBR} "Version {VERSION} is installed for the current user in $\"{FOLDER}$\"."
	LangString MULTIUSER_INSTALL_HEADER ${LANG_PORTUGUESEBR} "Select whether to install $(^NameDA) for all users or for the current user."
	...
	LangString MULTIUSER_NEW_INSTALLATION_CURRENT_USER ${LANG_PORTUGUESEBR} "Fresh installation for the current user."
	...
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_CURRENT_USER ${LANG_PORTUGUESEBR} "Uninstall version {OLD_VERSION} and install version {VERSION} for the current user."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_ALL_USERS ${LANG_PORTUGUESEBR} "Reinstall version {VERSION} for all users."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_CURRENT_USER ${LANG_PORTUGUESEBR} "Reinstall version {VERSION} for the current user."
	LangString MULTIUSER_RUN_AS_ADMIN ${LANG_PORTUGUESEBR} "You need to run this program as an administrator."
	LangString MULTIUSER_UNINSTALL_HEADER ${LANG_PORTUGUESEBR} "$(^NameDA) is installed both for all users and for the current user.$\r$\nSelect which installation to remove."
	LangString MULTIUSER_UNINSTALL_PAGE_SUBTITLE ${LANG_PORTUGUESEBR} "Choose for which users to remove $(^NameDA)."
	LangString SECTION_CORE_DESCRIPTION ${LANG_PORTUGUESEBR} "These are the basic files needed for ${prodname} to function (required)."
	LangString SECTION_CORE_NAME ${LANG_PORTUGUESEBR} "Escolha os arquivos para triturar"
	LangString SECTION_DESKTOP_DESCRIPTION ${LANG_PORTUGUESEBR} "Widgets para a Área de trabalho"
	...
	LangString SECTION_QUICK_LAUNCH_DESCRIPTION ${LANG_PORTUGUESEBR} "Create a shortcut on the Quick Launch bar."
	...
	LangString SECTION_START_MENU_DESCRIPTION ${LANG_PORTUGUESEBR} "Create a shortcut in the Start menu."
	LangString SECTION_START_MENU_NAME ${LANG_PORTUGUESEBR} "Start menu"
	LangString SECTION_TRANSLATIONS_DESCRIPTION ${LANG_PORTUGUESEBR} "Install language files to use ${prodname} in your preferred local language."
...
!ifdef LANG_SIMPCHINESE
	...
	LangString SECTION_TRANSLATIONS_DESCRIPTION ${LANG_SIMPCHINESE} "Install language files to use ${prodname} in your preferred local language."
...
!ifdef LANG_SWEDISH
	...
	LangString SECTION_INTEGRATE_SHRED_NAME ${LANG_SWEDISH} "Integrera förstöra"
