...
!ifdef LANG_ARMENIAN
	...
	LangString SECTION_CORE_DESCRIPTION ${LANG_ARMENIAN} "These are the basic files needed for ${prodname} to function (required)."
...
!ifdef LANG_HEBREW
	...
	LangString SECTION_TRANSLATIONS_DESCRIPTION ${LANG_HEBREW} "כדי להשתמש ב־${prodname} בשפת המערכת המקומית המועדפת עליך, יש להתקין את קובצי השפה ההכרחיים."
...
!ifdef LANG_INDONESIAN
	...
	LangString SECTION_TRANSLATIONS_DESCRIPTION ${LANG_INDONESIAN} "Gunakan ${prodname} dalam bahasa sistem lokal pilihan Anda, instal file bahasa yang diperlukan."
